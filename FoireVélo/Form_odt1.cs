...
namespace FoireVélo
{
    public partial class Form1 : Form
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            {
                m_databaseInterface.InsertDeposant(newdepForm.currentDeposant.Nom, newdepForm.currentDeposant.Prenom, newdepForm.currentDeposant.telephone, newdepForm.currentDeposant.paied);
                InitDeposantList();
        ...
        private void refreshDeposantInformation()
        {
            ...
            cbPaied.Checked = currentDeposant.paied;
        }
        ...
        private void BtnModify_Click(object sender, EventArgs e)
        {
            ...
            if (newdepForm.ShowDialog() == DialogResult.OK)
            {
                m_databaseInterface.UpdateDeposant(currentDeposant.Id, newdepForm.currentDeposant.Nom, newdepForm.currentDeposant.Prenom, newdepForm.currentDeposant.telephone, newdepForm.currentDeposant.paied);
                InitDeposantList();
                SelectCbIndexByName(newdepForm.currentDeposant.Nom);
            }
        }
        ...
        private void PrintList()
        {
            ...
            string droitEntree = "non";
            if (currentDeposant.paied)
            {
                droitEntree = "oui";
            }
            para.Range.Text += "Droit d'entrée payé: " + droitEntree ;

            para.Range.InsertParagraphAfter();

            Word.Paragraph para1 = word_doc.Paragraphs.Add(ref missing);
            para1.Range.Text = "Liste d'article";
            para1.Range.set_Style(ref style_name);
    ...
    true);
        ...
        private string GetSumArticle(List<Article> saleArticle, Deposant deposant)
        {
            ...
            {
                sumArticle += article.PrixVente + "+";
                somme += article.PrixVente;
            }
